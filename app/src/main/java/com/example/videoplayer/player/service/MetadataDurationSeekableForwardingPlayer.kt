 ...
 *
 * [Player.getDuration]/[Player.getContentDuration]：仅当内核返回无效（≤0 或 [C.TIME_UNSET]）时用元数据补齐，便于系统控件/会话客户端；迷你条与全屏条 [com.example.videoplayer.ui.media.uiDurationMs] 在内核时长有效时以内核为准，避免歌单元数据覆盖。
 *
